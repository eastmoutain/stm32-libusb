...
#define USBD_PRODUCT_FS_STRING        "xflyer"
...
__ALIGN_BEGIN uint8_t USBD_DeviceQualifierDesc[USB_LEN_DEV_QUALIFIER_DESC] __ALIGN_END =
{
  ...
  USB_DESC_TYPE_DEVICE_QUALIFIER, // device descriptor type
  0x00,  // bcd usb low 
  0x02,  // bcd usb high
  0xff,  // device class
...
/**
  * @}
  */ 
 void user_read_buf(const char* buf, uint16_t len)
 {
    char data[64];
    for (int i = 0; i < 64; ++i) {
        data[i] = 0;
